...
INSERT INTO "new_invoices" ("balance", "businessId", "createdAt", "currencyCode", "customerId", "discountAmount", "dueDate", "exchangeRate", "id", "invoiceDate", "invoiceNumber", "isDeleted", "notes", "orderId", "paidAmount", "status", "subtotal", "taxAmount", "totalAmount", "updatedAt") SELECT "balance", "businessId", "createdAt", "currencyCode", "customerId", "discountAmount", "dueDate", "exchangeRate", "id", "invoiceDate", "invoiceNumber", "isDeleted", "notes", "orderId", "paidAmount", "status", "subtotal", "taxAmount", "totalAmount", "updatedAt" FROM "invoices";
DROP TABLE "invoices";
